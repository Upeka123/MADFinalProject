...
import com.example.expensetrackerforuniversitystudent.activity.Questions1Activity;
...
public class Sets1Adapter extends RecyclerView.Adapter<Sets1Adapter.ViewHolder> {

    private List<String> setList;

    public Sets1Adapter(List<String> setList) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.set_items1, parent, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            isLoading.getWindow().setBackgroundDrawableResource(R.drawable.edittext1);
            isLoading.getWindow().setLayout(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
        }

        private void setData(int position, final String setListId, final Sets1Adapter adapter) {
...
//                    SetsActivity.selectedCatIndex=position;
                    ...
                    Intent intent = new Intent(itemView.getContext(), Questions1Activity.class);
            ...
            setDeleteBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    dialog.getWindow().setBackgroundDrawableResource(R.drawable.edittext1);
        ...
        @RequiresApi(api = Build.VERSION_CODES.KITKAT)
        private void deleteSet(int position, String setListId, final Context context, final Sets1Adapter adapter) {
            isLoading.show();
